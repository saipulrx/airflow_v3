...
PRODUCT_ASSET = Asset("gs://raw_data_dwh_modeling/processed_data/clean_products.csv")
# ==========================================
# KONFIGURASI
# ==========================================
# Menggunakan URL Raw GitHub yang tepat
GITHUB_RAW_URL = "https://raw.githubusercontent.com/saipulrx/dbt-bigquery-colibri/refs/heads/main/seeds/raw_product.csv"
...
def etl_sales_data():
    ...
    def extract_data() -> str:
        ...
        local_raw_path = os.path.join(LOCAL_TMP_DIR, "raw_product.csv")
    ...
    def transform_data(raw_file_path: str) -> str:
        ...
        clean_file_path = os.path.join(LOCAL_TMP_DIR, "clean_products.csv")
    ...
    upload_clean_to_gcs = LocalFilesystemToGCSOperator(
        ...
        src=clean_path,
        dst="processed_data/clean_products.csv",
        bucket=GCS_BUCKET,
        outlets=[PRODUCT_ASSET] # Men-trigger Airflow Assets
    )
    ...
    load_to_bq = GCSToBigQueryOperator(
        task_id="load_to_bq",
        bucket=GCS_BUCKET,
        source_objects=["processed_data/clean_products.csv"],
        destination_project_dataset_table=f"{GCP_PROJECT_ID}.{BQ_DATASET_NAME}.dim_product",
        source_format="CSV",
        skip_leading_rows=1,
